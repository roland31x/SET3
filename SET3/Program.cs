...
namespace SET3
{
    internal class Program
    {
        ...
        private static void P31()
        {
            ...
            count = 0; // aparent wikipedia zice ca nu se poate determina daca un element este sigur majoritar fara o a doua parcurgere in care verificam daca "voturile" sunt majoritare.
            for(int i = 0; i < arr.Length; i++)
            {
                if (arr[i] == candidate)
                {
            ...
            {
                Console.WriteLine($"Element majoritar: {candidate}.");
                return;
            }
            Console.WriteLine("Nu are element majoritar.");
        }
